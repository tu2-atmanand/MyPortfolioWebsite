...
const greeting = {
  title: "Hello 👋.",
  title2: "Atmanand",
  logo_name: "ATMANAND GAUNS",
  nickname: "Anand / picleric",
  full_name: "Atmanand Gauns",
  subTitle:
...
const socialMediaLinks = {
  ...
  github: "https://github.com/tu2-atmanand",
  linkedin: "https://www.linkedin.com/in/atmanand-gauns-32017520b/",
  gmail: "sanketgauns8@gmail.com",
  gitlab: "https://gitlab.com/Tu2_atmanand",
  twitter: "https://twitter.com/AtmanandGauns",
  instagram: "https://www.instagram.com/tu2.atmanand/",
};
  ...
  data: [
    {
      ...
      skills: [
        ...
        "⚡ Creating Desktop application in C++ and React Native",
      ],
      softwareSkills: [
        {
          skillName: "HTML5",
      ...
      experiences: [
        {
          ...
          location: "Online",
          description:
            "Trained with C++ programming language and developed Student Management Terminal Based application during the internship",
      ...
      experiences: [
        {
          ...
          location: "Farmagudi",
          description:
            "Assets is an Non-profit organization to conduct events and worksops for development of students. My role in the council is to maintain and update the main website and to volunteer in the events conducted for online communication.",
          color: "#FBBD18",
        },
        {
          ...
          location: "",
          description:
            "Volunteered in the various events conducted by IEEE Student branch of GEC.",
          color: "#4285F4",
        },
        // {
...
const projectsHeader = {
  title: "Projects",
  description:
    "My projects make use of a vast variety of latest technology tools. My best experience is to create Python Machine Learning Application, C++ Applications. Below are some of my projects. Note that not all of the mentioned projects are on GitHub yet.",
...
const projects = {
  data: [
    ...
    // },
    {
      ...
      url: "https://github.com/tu2-atmanand/Speech_Recognition",
      description:
        "An analysis project to find the best Speech Recognizer to use in other projects. The Project now uses the Vosk Technology to implement this feature.",
      languages: [
        {
    ...
    {
      id: "4",
      name: "tu2-atmanand.github.io",
      url: "https://github.com/tu2-atmanand/tu2-atmanand.github.io",
      description:
